    ...
    // void youtube(string photo , string tittle , int views , int time ){
    //     cout<<"Crate a box height 2 cm and weidth 2 cm"<<photo<<endl;
    //     // cout<<"Put the thumbnil inside the box"<<tittle<<endl;
    //     cout<<"Put the tittle "<<tittle<<endl;
    //     cout<<"Print views"<<views<<endl;
